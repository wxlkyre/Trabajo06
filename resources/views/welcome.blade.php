                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                            <h1 class="text-4xl font-bold text-center text-gray-900">Aleida Judith Maldonado Mora</h1>
                            <p class="text-lg text-center">Esta es la página de inicio de mi proyecto Laravel.</p>
